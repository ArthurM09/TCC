...
np.save('/Users/arthu/TCC2/dados_preparados/mlp/label_encoder_classes.npy', label_encoder.classes_)
...
np.save('/Users/arthu/TCC2/dados_preparados/mlp/X_train.npy', X_train_scaled)
np.save('/Users/arthu/TCC2/dados_preparados/mlp/X_test.npy', X_test_scaled)
np.save('/Users/arthu/TCC2/dados_preparados/mlp/y_train_encoded.npy', y_train_encoded)
np.save('/Users/arthu/TCC2/dados_preparados/mlp/y_test_encoded.npy', y_test_encoded)

# Salvar também os nomes das features para referência
with open('/Users/arthu/TCC2/dados_preparados/mlp/feature_names.txt', 'w') as f:
    f.write('\n'.join(numeric_cols))
