...
print("Carregando os dados preparados para SVM...")
...
with open(os.path.join(OUTPUT_PATH, "svm_report.txt"), "w") as f:
...
plt.xlabel("Predito")
plt.ylabel("Real")
plt.title("Matriz de Confusão - SVM Landmarks")
plt.xticks(rotation=45, ha='right')
plt.yticks(rotation=0)
plt.tight_layout()
plt.savefig(os.path.join(IMAGES_PATH, "svm_confusion_matrix.png"))
...
print("\nTreinamento e avaliação do SVM para Landmarks concluídos com sucesso!")